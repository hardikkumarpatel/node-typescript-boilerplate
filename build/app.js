...
class ExpressApp {
  ...
  static initializeRoutes() {
    var _this2 = this;
    return _asyncToGenerator(function* () {
      _this2.App.use("/health", _helpers.AppHelper.useAppHealthRoute);
      // this.App.use(routes);
    })();
  }
  static initializeMiddleware() {
    var _this3 = this;
    return _asyncToGenerator(function* () {
      _this3.App.use(_express.default.urlencoded({
        limit: "6kb",
        extended: true
      }));
      _this3.App.use(_express.default.json({
        limit: "6kb"
      }));
      _this3.App.use((0, _morgan.default)("combined", {
        stream: {
          write: _helpers.Log.http
        }
      }));
      _this3.App.use("/public", _express.default.static(_nodePath.default.resolve(_nodePath.default.join(__dirname), "src", "public")));
      _this3.App.use((0, _cors.default)({
        origin: "*",
        methods: ["GET", "HEAD", "PUT", "OPTIONS", "PATCH", "POST", "DELETE"]
      }));
      _this3.App.use((0, _helmet.default)({
        contentSecurityPolicy: false
      }));
      _this3.App.use((0, _cookieParser.default)());
    })();
  }
  ...
  static initializeGlobalMiddleware() {
    ...
    return _asyncToGenerator(function* () {
      ...
      _this4.App.use(_middleware.ApiErrorHelperMiddleware.useGlobalErrorMiddleware);
    })();
  }
}
