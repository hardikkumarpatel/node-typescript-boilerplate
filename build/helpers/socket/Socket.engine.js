...
class SocketEngineApp {
  constructor(http) {
    SocketEngineApp.IO = new _socket.Server(http, {
      cors: {
        origin: '*'
      },
  ...
  static intiSocket() {
    return _asyncToGenerator(function* () {
      _.Log.info("Socket app connected and initialized \uD83D\uDE80");
      SocketEngineApp.IO.on("connection", /*#__PURE__*/function () {
...
var _default = exports.default = SocketEngineApp;
