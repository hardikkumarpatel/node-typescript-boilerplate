...
var _Options = _interopRequireDefault(require("./Options.swagger"));
...
class SwaggerApp {
  ...
  initialize() {
    ...
    return _asyncToGenerator(function* () {
      ...
      _this.app.use("/docs", _swaggerUiExpress.default.serve, _swaggerUiExpress.default.setup((0, _swaggerJsdoc.default)(_Options.default), {
        explorer: true,
        swaggerOptions: {
          docExpansion: "none"
        }
      ...
      _this.app.get("/docs.json", _helpers.ApiAsyncHelper.AsyncHandler( /*#__PURE__*/function () {
        var _ref = _asyncToGenerator(function* (_, res) {
          ...
          res.send((0, _swaggerJsdoc.default)(_Options.default));
        });
